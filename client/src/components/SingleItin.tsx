...
function Activities({ more, itinId }: ActivitiesProps) {
...
function SingleItin({ itin, selectedItin, handleSelection, cityName, isLiked }: SingleItinProps) {
  return (
